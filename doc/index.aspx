...
<meta name="WebPartPageExpansion" content="full" />
        <title>Jello for Sharepoint</title>
        <script type="text/javascript" src="//ajax.aspnetcdn.com/ajax/4.0/1/MicrosoftAjax.js"></script>
        <script src="/_layouts/15/sp.js" type="text/javascript"></script>
        <script src="jquery-2.1.3.min.js"></script>
        <script src="../lib/jello.js"></script>
        
    </head>
    <body>
        
        <h1>Jello for Sharepoint</h1>
        <p>I've tried to make this quick and dirty. You can find the usage for Jello in the source of this page.</p>

        <script>
            var TaskList = new Jello("https://jello.sharepoint.com/sites/sprest",{
                name: "TaskList",
